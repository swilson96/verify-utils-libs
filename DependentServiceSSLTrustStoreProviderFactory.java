 ...
 * {@link DependentServiceSSLTrustStoreProvider} needs to be mocked so that it does
 ...
 * method.
 */
public class DependentServiceSSLTrustStoreProviderFactory {
    public DependentServiceSSLTrustStoreProvider create(ClientTrustStoreConfiguration clientTrustStoreConfiguration) {
        return new DependentServiceSSLTrustStoreProvider(clientTrustStoreConfiguration);
    }
}
